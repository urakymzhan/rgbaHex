export default [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: "grayyy", color: "#9E9E8E" }
    ]
  },
  {
    paletteName: "Lion Colors",
    id: "lion-colors",
    emoji: "🦁",
    colors: [
